...
class Game {
  ...
  getGameStateSnapshot() {
    return {
        ...
        minimumRaise: this.minimumRaise,
        correctAnswer: (this.state === GameState.SHOWDOWN || this.state === GameState.WAITING || this.state === GameState.BETTING_ROUND_4 || this.state === GameState.ANSWER_REVEAL) ? this.correctAnswer : undefined, // Show correct answer only at showdown/end or after reveal
  ...
  getGameStateForClient(socketId) {
    ...
    if (this.state !== GameState.SHOWDOWN && this.state !== GameState.WAITING && this.state !== GameState.BETTING_ROUND_4 && this.state !== GameState.ANSWER_REVEAL) {
